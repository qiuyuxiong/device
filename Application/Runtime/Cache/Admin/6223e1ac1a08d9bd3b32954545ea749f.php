...
<div class="pd-20">
    ...
    <div id="tabbody-div">
        <form name="main_form" align="center" class="Huiform" method="POST" action="/device/index.php/Admin/Device/edit/id/1/p/2.html" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php echo ($data["id"]); ?>" />
            ...
            <table class="table_content" cellspacing="1" cellpadding="3" width="100%">
                <tr>
                    ...
                    <td>
                        <input type="text" placeholder="设备名称" name="device_name" autocomplete="off" class="input-text" value="<?php echo ($data["device_name"]); ?>" style=" width:150px">
                    </td>
                </tr>
                <tr>
                   
                    <td>
                        <input type="text" placeholder="设备数量" name="device_number" autocomplete="off" class="input-text" value="<?php echo ($data["device_number"]); ?>" style=" width:150px">
                    </td>
                </tr>
                <tr>
                    ...
                    <span style="margin-left:-70px">设备分类：</span>
                        <select name="cat_id">
                            ...
                            <?php foreach ($catData as $k => $v): if($v['id'] == $data['cat_id']) $select = 'selected="selected"'; else $select = ''; ?>
                                <option <?php echo ($select); ?> value="<?php echo ($v["id"]); ?>"><?php echo str_repeat('&nbsp;',$v['level'] * 6); echo ($v["cat_name"]); ?></option>
            ...
            <table class="table_content" cellspacing="1" cellpadding="3" width="100%" style="display:none;">
                <tr>
                    <td>
                        <textarea id="device_desc" name="device_desc"><?php echo ($data["device_desc"]); ?></textarea>
                    </td>
                </tr>
            </table>
