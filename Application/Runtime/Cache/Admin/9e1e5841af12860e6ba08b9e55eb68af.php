...
<body>
<nav class="breadcrumb"><i class="iconfont">&#xf012b;</i> 首页 <span class="c-gray en">&gt;</span> 类型管理 <span class="c-gray en">&gt;</span>类型列表 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="icon-refresh"></i></a></nav>
<div class="pd-20">
	 <div class="text-c"> 
	 <form action="" method="get">
    <input type="text" class="input-text" style="width:250px" placeholder="输入类型名称" id="" name="type_name" value="<?php echo I('get.type_name'); ?>"><input type="submit" class="btn btn-success" value="搜类型" />
    </form>
  </div>
  <div class="cl pd-5 bg-1 bk-gray">
    <span class="l">
      <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="icon-trash"></i> 批量删除</a>
      <a class="btn btn-primary radius" href="javascript:;" onclick="admin_role_add('750','','添加类型','/device/index.php/Admin/Type/add')"><i class="icon-plus"></i> 添加类型</a>
    </span>
  ...
  <table class="table table-border table-bordered table-hover table-bg">
    <thead>
      <tr>
        <th scope="col" colspan="4">类型管理</th>
      </tr>
      <tr class="text-c">
