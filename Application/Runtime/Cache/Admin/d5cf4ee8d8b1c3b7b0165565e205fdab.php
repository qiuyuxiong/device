...
<div class="pd-20">
<div class="text-c">
    <form class="Huiform" name='main_form' method="post" action="/device/index.php/Admin/Privilege/edit/id/40/p/1.html">
      ...
      <span style="margin-left:-100px;">上级权限:</span>
       ...
       <select name="parent_id">
                        ...
                        <option <?php if($v['id'] == $data['parent_id']): ?>selected="selected"<?php endif; ?> value="<?php echo $v['id']; ?>"><?php echo str_repeat('&nbsp;', 6*$v['level']).$v['pri_name']; ?></option>
                        <?php endforeach; ?>                    </select><br />
        <input type="text" placeholder="权限名称" name="pri_name" autocomplete="off" value="<?php echo ($data["pri_name"]); ?>" class="input-text" style=" width:150px"><br />
        <input type="text" placeholder="模块名称" name="module_name" autocomplete="off" value="<?php echo ($data["module_name"]); ?>" class="input-text" style=" width:150px"><br />
        <input type="text" placeholder="控制器名称" name="controller_name" autocomplete="off" value="<?php echo ($data["controller_name"]); ?>" class="input-text" style=" width:150px"><br />
        <input type="text" placeholder="方法名称" name="action_name" autocomplete="off" value="<?php echo ($data["action_name"]); ?>" class="input-text" style=" width:150px"><br />
