...
<div class="pd-20">
<div class="text-c">
    <form class="Huiform" name='main_form' method="post" action="/device/index.php/Admin/Category/edit/id/2/p/1.html">
      ...
      <span style="margin-left:-100px;">上级权限:</span>
       ...
       <select name="parent_id">
        ...
        <input type="text" placeholder="分类名称" name="cat_name" autocomplete="off" value="<?php echo ($data["cat_name"]); ?>" class="input-text" style=" width:150px">
        
        <input type="text" placeholder="筛选选属性ID，多个ID用逗号隔开" name="search_attr_id" autocomplete="off" value="<?php echo ($data["search_attr_id"]); ?>" class="input-text" style=" width:270px"><br />
