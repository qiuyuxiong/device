...
<div class="pd-20">
<div class="text-c">
    <form class="Huiform" method="post" action="/device/index.php/Admin/Type/add">
    
        
      <input type="text" placeholder="类型名称" name="type_name" autocomplete="off" class="input-text" style=" width:150px"><br />
