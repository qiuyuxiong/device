...
<head>
<title>设备信息管理菜单</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<link href="/device/Public/Admin/Styles/general.css" rel="stylesheet" type="text/css" />
...
.explode {
  background:url(/device/Public/Admin/Images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(/device/Public/Admin/Images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(/device/Public/Admin/Images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/device/Public/Admin/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            ...
            设备管理
                <ul>
                    <li class="menu-item"><a href="/device/index.php/Admin/Device/lst" target="main-frame">设备列表</a></li>
                    <li class="menu-item"><a href="/device/index.php/Admin/Device/add" target="main-frame">添加新设备</a></li>
                    <li class="menu-item"><a href="/device/index.php/Admin/Category/lst" target="main-frame">设备分类</a></li>
            ...
            权限管理
                <ul>
                    <li class="menu-item"><a href="/device/index.php/Admin/Privilege/lst" target="main-frame">权限列表</a></li>
                    <li class="menu-item"><a href="/device/index.php/Admin/Role/lst" target="main-frame">角色列表</a></li>
                    <li class="menu-item"><a href="/device/index.php/Admin/Admin/lst" target="main-frame">管理员列表</a></li>
                </ul>
            </li>
        </ul>
    </div>
...
<script type="text/javascript" src="/device/Public/Admin/Js/global.js"></script>
<script type="text/javascript" src="/device/Public/Admin/Js/utils.js"></script>
<script type="text/javascript" src="/device/Public/Admin/Js/transport.js"></script>
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '/device/Public/Admin/Images/menu_minus.gif' : '/device/Public/Admin/Images/menu_plus.gif';
